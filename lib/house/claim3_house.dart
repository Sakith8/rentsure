...
import 'package:rentsure/house/claim4_house.dart';
...
void main() {
  runApp(const Claim3House());
}

class Claim3House extends StatelessWidget {
  const Claim3House({super.key});
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Claim4House()),
                    );
                  },
                ),
              ),
