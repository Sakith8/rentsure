...
import 'package:rentsure/house/claim3_house.dart';
...
void main() {
  runApp(const Claim2House());
}

class Claim2House extends StatelessWidget {
  const Claim2House({super.key});
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Claim3House()),
                    );
                  },
                ),
              ),
