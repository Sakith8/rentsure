...
import 'package:rentsure/building/claim2_build.dart';
...
void main() {
  runApp(const Claim1Build());
}

class Claim1Build extends StatelessWidget {
  const Claim1Build({super.key});
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Claim2Build()),
                    );
                  },
                ),
              ),
